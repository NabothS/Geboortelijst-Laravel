    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center sm:justify-start sm:pt-0 items-center h-full">
                    <img src="/images/pacifier.png" alt="" class="logoHome h-10 md:h-36 mr-6">
                    <h1 class="text-[#51B1DB] hometitle text-4xl md:text-9xl">{{__('EBaby')}}</h1>
                </div>
