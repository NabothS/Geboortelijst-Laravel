...
<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="/images/pacifier.png" alt="" class="logoPaci  h-10">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if ($user->isAdmin == 0)
                        <x-nav-link :href="route('makeList')" :active="request()->routeIs('makeList')">
                            {{ __('Maak Een Lijst') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if ($user->isAdmin == 0)
                <x-responsive-nav-link :href="route('makeList')" :active="request()->routeIs('makeList')">
                    {{ __('Maak Een Lijst') }}
                </x-responsive-nav-link>
            @endif
            ...
            @if ($user->isAdmin == 1)
                ...
                <x-responsive-nav-link :href="route('scraper')" :active="request()->routeIs('scraper')">
                    {{ __('Scraper') }}
                </x-responsive-nav-link>
            @endif
        </div>
